...
public class DSPFileConstants {
    ...
    //data offsets
    public static final long NIBBLE_COUNT_OFFSET = 0x4;
    ...
    public static final long LOOP_END_OFFSET = 0x14;
    public static final long DECODE_COEFFS_OFFSET = 0x1C;
    public static final long AUDIO_DATA_OFFSET = 0x60;

    //data length
    public static final int NIBBLE_COUNT_LENGTH_IN_BYTES = 4;
    ...
    public static final int LOOP_END_LENGTH_IN_BYTES = 4;
    public static final int DECODE_COEFFS_LENGTH_IN_BYTES = 32;
}
